...
import { useDrawer } from './overlays/AppOverlaysProvider';

/**
 * Header marrom mobile: logo, "Mason Connect", nome do núcleo, botão ☰ que
 * abre o `Drawer` de menu (Task 7) via `useDrawer()`.
